...
import { Button, Container } from "@components/custom";
import { fetchSnapUsers, fetchUsers } from "@utils/dbUtils";
...
export default function index() {
 ...
 history.replace({
  ...
  return (
    <Container>
      {
        auth.currentUser==null ?  <Spin></Spin> :
